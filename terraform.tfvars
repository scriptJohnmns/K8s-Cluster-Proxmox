...
masters = {
  "manager1-k8s" = { vm_id=212, cpu_cores=2, cpu_type="host", memory_mb=4096, disk_size=50, ipv4_address="192.168.18.212/24" }
...
workers = {
  "worker1-k8s"  = { vm_id=215, cpu_cores=1, cpu_type="host", memory_mb=2048, disk_size=25, ipv4_address="192.168.18.215/24" }
